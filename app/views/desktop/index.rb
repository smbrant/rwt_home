...
rwt_app do
  toolbar(:place=>'tb') do
    menu(t(:'menu.home.header')) do
      menu_item(t(:'menu.home.what_is_this'),function("Ext.get('main').getUpdater().update({url:'/what_is_this.html'})"))
      menu_item(t(:'menu.home.getting_started'),function("show_html('/getting_started.html')"))
